const docCategories = [
  ...
  },
  {
    ...
    color: "violet",
    docs: [
      { name: "Secure Plugin Isolation & Interface Enforcement Proposal – Vithana K.M.N.", type: "PDF", file: "#final-vithana.pdf", size: "Mock File" },
      { name: "Secure Communication & Authentication Mechanism - Gunawardana M.A.Y.N.", type: "PDF", file: "#final-gunawardana.pdf", size: "Mock File" },
      { name: "Automated UML Code Visualization Proposal - Vithanage V.D.S.I.", type: "PDF", file: "#final-vithanage.pdf", size: "Mock File" },
      { name: "Secure By Design AI Code Generator - Prabhasari P.T.P.", type: "PDF", file: "#final-prabhasari.pdf", size: "Mock File" },
